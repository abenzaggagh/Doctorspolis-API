...
import com.doctorspolis.backend.utility.SearchController;
...
public class DoctorController implements SearchController<DoctorDTO> {
    ...
    public ResponseEntity<DoctorDTO> one(@PathVariable Long doctorID) throws ResourceNotFoundException {
    ...
    public ResponseEntity<DoctorDTO> update(@PathVariable Long doctorID,
                                            @RequestBody DoctorDTO doctorDTO) throws ResourceNotFoundException {
    ...
    public ResponseEntity<Boolean> delete(@PathVariable Long doctorID) throws ResourceNotFoundException {
    ...
    class WorkSchedule {
        ...
        @PostMapping
        public ResponseEntity<Collection<WorkScheduleDTO>> create(@PathVariable Long doctorID, @RequestBody @Validated WorkScheduleDTO workScheduleDTO) {
            return ResponseEntity.status(HttpStatus.CREATED).body(doctorService.addWorkScheduleByID(doctorID, workScheduleDTO));
        }

        @PutMapping
        public ResponseEntity<Collection<WorkScheduleDTO>> update(@PathVariable Long doctorID, @RequestBody WorkScheduleWrapper workSchedules) {
        ...
        public ResponseEntity<WorkScheduleDTO> edit(@PathVariable Long doctorID, @PathVariable Long workScheduleID, @RequestBody WorkScheduleDTO workScheduleDTO) {
        ...
        public ResponseEntity<Collection<WorkScheduleDTO>> delete(@PathVariable Long doctorID, @PathVariable Long workScheduleID) throws ResourceNotFoundException {
    ...
    class Prescriptions {
        ...
        @PostMapping
        public ResponseEntity<PrescriptionDTO> create(@AuthenticationPrincipal User user, @PathVariable Long doctorID, @RequestBody PrescriptionDTO prescriptionDTO) {
